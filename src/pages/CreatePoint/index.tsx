...
const CreatePoint = () => {
    ...
    // Sempre que a gente cria um estado para um array ou objeto  precisamos manualmente informar o tipo da variavel armazenada
    ...
    //UseEffect recebe 2 parametros : 1 parametro: qual função eu quero executar, 2 parametro: quando eu quero que execute, por exemplo quando uma informação mudar
        ...
        <div id="page-create-point">
            ...
            <form onSubmit={handleSumit}>
                ...
                <fieldset>
                    <legend>
                        <h2>Endereço</h2>
                        <span>Seleciona um espaço no mapa</span>
                    </legend>
